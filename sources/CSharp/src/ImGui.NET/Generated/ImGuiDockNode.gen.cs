...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiDockNodePtr
    {
        ...
        public ImPtrVector<IntPtr> Windows => new ImPtrVector<IntPtr>(NativePtr->Windows, sizeof(void*));
        public IntPtr TabBar { get => (IntPtr)NativePtr->TabBar; set => NativePtr->TabBar = (void*)value; }
        ...
        public IntPtr HostWindow { get => (IntPtr)NativePtr->HostWindow; set => NativePtr->HostWindow = (void*)value; }
        public IntPtr VisibleWindow { get => (IntPtr)NativePtr->VisibleWindow; set => NativePtr->VisibleWindow = (void*)value; }
        ...
        public ImRect Rect()
        {
            ImRect ret = ImGuiNative.ImGuiDockNode_Rect((ImGuiDockNode*)(NativePtr));
            return ret;
        }
