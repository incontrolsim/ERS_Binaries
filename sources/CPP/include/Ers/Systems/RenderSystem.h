...
namespace Ers
{
    ...
    {
      public:
        /// @brief Render the RenderComponent on all eligible entities in a given submodel in 2D.
        ...
        /// @brief Render the RenderComponent on all eligible entities in a given submodel in 3D.
        /// @param subModel The submodel in which the basic renders are rendered.
        /// @param renderContext The render context to use.
